...
function validateForm() {
  ...
  var ef= document.forms["myForm"]["fparty"].value;
  ...
  if(z<35)
  {
      alert("Age must be greater than 35");
      return false;
  }
...
<body>
    ...
    <h1>REGISTRATION FORM(Candidate)</h1> </p>
<form name="myForm" action="third.php" onsubmit="return validateForm()" method="post">
    <div class="container">
        <div class="row">
                <div class="col-25">
...
<div class="col-75">
 <input type="text" name="fparty" placeholder="Enter your Party  Name">
</div>
</div>
<div class="row">
  <div class="col-25">
...
{	
  $aadhar=$_POST['fname']; 
   ...
   $state = $_POST['state'];
   $mobno = $_POST['fmobile'];
	 $sql = "INSERT INTO candidate_details (adhar,name,party_name,dob,age,gender,	email,address,city,zip_code,state,mob_no) VALUES ('$aadhar','$name','$pname','$date','$age','$gender','$email','$address','$city','$zipcode','$state','$mobno')";
