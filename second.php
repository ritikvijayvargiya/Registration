...
<body>
    ...
    <h1>REGISTRATION FORM(Voters)</h1> </p>
<form name="myForm" action="second.php" onsubmit="return validateForm()" method="post">
    <div class="container">
        <div class="row">
                <div class="col-25">
...
{	
  $aadhar=$_POST['fname']; 
   ...
   $state = $_POST['state'];
   $mobno = $_POST['fmobile'];
	 $sql = "INSERT INTO user_details (adhar,name,dob,age,gender,	email,address,city,zip_code,state,mob_no) VALUES ('$aadhar','$name','$date','$age','$gender','$email','$address','$city','$zipcode','$state','$mobno')";
